...
# As a method of nose.tools， assert_raises(exception, callable, parameters) tests to make sure a specified exception can be raised when presented with certain parameters.
